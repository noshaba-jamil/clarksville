...
export const metadata: Metadata = { title:"Water Damage Odor Removal Clarksville TN | Mold & Mildew Smell | (931) 271-2350", description:"Musty water damage odor in your Clarksville TN home? Professional odor elimination at the biological source. HEPA, hydroxyl, ozone treatments. Call (931) 271-2350.", alternates:{canonical:"/water-damage-odor-removal-clarksville-tn"} };
export default function Page() {
  return (<>
    <PageHero eyebrow="Professional Odor Elimination" title="Water Damage Odor Removal in Clarksville TN" subtitle="Musty water damage odor in your Clarksville TN home? Professional odor elimination at the biological source. HEPA, hydroxyl, ozone treatments. Call (931) 271-2350." image="https://images.unsplash.com/photo-1558618666-fcd25c85cd64?auto=format&fit=crop&w=1800&q=80" imageFocus="center 40%" breadcrumbs={[{label:"Water Damage Odor Removal in Clarksville TN"}]} stat1="60min" stat1Sub="Guaranteed Arrival" stat2="24/7" stat2Sub="Always Available"/>
    ...
    <div style={{background:"#fff"}}>
      <div className="sp">
        <main>
          ...
          <h2 className="sp-h">Water Damage Odor Removal in Clarksville TN</h2>
          <p className="sp-p">Musty water damage odor in your Clarksville TN home? Professional odor elimination at the biological source. HEPA, hydroxyl, ozone treatments. Call (931) 271-2350. Our IICRC-certified Clarksville team responds within 60 minutes — 24 hours a day, 7 days a week. All insurance accepted including USAA for Fort Campbell military families.</p>
