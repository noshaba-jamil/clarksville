...
export const metadata: Metadata = { title:"Mold Remediation Clarksville TN | Black Mold Removal | (931) 271-2350", description:"IICRC-certified mold remediation in Clarksville TN. Black mold removal, containment, HEPA filtration. All insurance. Call (931) 271-2350.", alternates:{canonical:"/mold-remediation-clarksville-tn"} };
export default function Page() {
  return (<>
    <PageHero eyebrow="IICRC-Certified Mold Remediation" title="Mold Remediation & Black Mold Removal in Clarksville TN" subtitle="IICRC-certified mold remediation in Clarksville TN. Black mold removal, containment, HEPA filtration. All insurance. Call (931) 271-2350." image="https://images.unsplash.com/photo-1584622650111-993a426fbf0a?auto=format&fit=crop&w=1800&q=80" imageFocus="center 40%" breadcrumbs={[{label:"Mold Remediation & Black Mold Removal in Clarksville TN"}]} stat1="60min" stat1Sub="Guaranteed Arrival" stat2="24/7" stat2Sub="Always Available"/>
    ...
    <div style={{background:"#fff"}}>
      <div className="sp">
        <main>
          ...
          <h2 className="sp-h">Mold Remediation & Black Mold Removal in Clarksville TN</h2>
          <p className="sp-p">IICRC-certified mold remediation in Clarksville TN. Black mold removal, containment, HEPA filtration. All insurance. Call (931) 271-2350. Our IICRC-certified Clarksville team responds within 60 minutes — 24 hours a day, 7 days a week. All insurance accepted including USAA for Fort Campbell military families.</p>
