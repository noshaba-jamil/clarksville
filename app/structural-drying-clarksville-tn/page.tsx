...
export const metadata: Metadata = { title:"Structural Drying Clarksville TN | IICRC S500 Certified | (931) 271-2350", description:"Professional structural drying in Clarksville TN. Industrial air movers, LGR dehumidifiers, daily moisture monitoring. IICRC S500. Call (931) 271-2350.", alternates:{canonical:"/structural-drying-clarksville-tn"} };
export default function Page() {
  return (<>
    <PageHero eyebrow="IICRC S500 Certified Structural Drying" title="Structural Drying & Dehumidification in Clarksville TN" subtitle="Professional structural drying in Clarksville TN. Industrial air movers, LGR dehumidifiers, daily moisture monitoring. IICRC S500. Call (931) 271-2350." image="https://images.unsplash.com/photo-1600566752355-35792bedcfea?auto=format&fit=crop&w=1800&q=80" imageFocus="center 40%" breadcrumbs={[{label:"Structural Drying & Dehumidification in Clarksville TN"}]} stat1="60min" stat1Sub="Guaranteed Arrival" stat2="24/7" stat2Sub="Always Available"/>
    ...
    <div style={{background:"#fff"}}>
      <div className="sp">
        <main>
          ...
          <h2 className="sp-h">Structural Drying & Dehumidification in Clarksville TN</h2>
          <p className="sp-p">Professional structural drying in Clarksville TN. Industrial air movers, LGR dehumidifiers, daily moisture monitoring. IICRC S500. Call (931) 271-2350. Our IICRC-certified Clarksville team responds within 60 minutes — 24 hours a day, 7 days a week. All insurance accepted including USAA for Fort Campbell military families.</p>
