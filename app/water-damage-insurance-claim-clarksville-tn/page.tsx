...
export const metadata: Metadata = { title:"Water Damage Insurance Claims Clarksville TN | USAA Specialists | (931) 271-2350", description:"Water damage insurance claims in Clarksville TN handled completely. USAA specialists for Fort Campbell. Documentation, adjuster comms & direct billing. Call (931) 271-2350.", alternates:{canonical:"/water-damage-insurance-claim-clarksville-tn"} };
export default function Page() {
  return (<>
    <PageHero eyebrow="Insurance Claim Specialists" title="Water Damage Insurance Claims — We Handle Everything" subtitle="Water damage insurance claims in Clarksville TN handled completely. USAA specialists for Fort Campbell. Documentation, adjuster comms & direct billing. Call (931) 271-2350." image="https://images.unsplash.com/photo-1560472354-b33ff0c44a43?auto=format&fit=crop&w=1800&q=80" imageFocus="center 40%" breadcrumbs={[{label:"Water Damage Insurance Claims — We Handle Everything"}]} stat1="60min" stat1Sub="Guaranteed Arrival" stat2="24/7" stat2Sub="Always Available"/>
    ...
    <div style={{background:"#fff"}}>
      <div className="sp">
        <main>
          ...
          <h2 className="sp-h">Water Damage Insurance Claims — We Handle Everything</h2>
          <p className="sp-p">Water damage insurance claims in Clarksville TN handled completely. USAA specialists for Fort Campbell. Documentation, adjuster comms & direct billing. Call (931) 271-2350. Our IICRC-certified Clarksville team responds within 60 minutes — 24 hours a day, 7 days a week. All insurance accepted including USAA for Fort Campbell military families.</p>
